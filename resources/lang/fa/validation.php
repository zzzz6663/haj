...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'goal' => ' هدف',
        'admin_name' => ' مدیر مجموعه',
        'job' => ' نوع مجموعه',
        'price' => 'قیمت  ',
        'visiting_hours' => 'ساعت بازدید ',
        'confirm' => ' تایید مجموعه',
        'welfare' => ' امکانات ',
        'history' => ' تاریخچه',
        'unit' => 'واحد ',
        'weight' => 'وزن ',
        'dimension' => 'ابعاد  ',
        'province_id' => 'استان ',
        'register_deadline' => ' مهلت ثبت نام',
        'capacity' => 'ظرفیت ',
        'balad' => ' بلد سفر',
        'destination' => ' مقصد',
        'origin' => ' مبدا',
        ...
        'floor' => ' طبقه',
        'ca_normal' => 'ظرفیت تخت ',
        'ca_vip' => 'ظرفیت کف خواب  ',
        'male' => ' تعداد افراد اقا ',
        'female' => ' تعداد افراد خانم ',
        'single' => 'انتخاب یک اتاق دربست  ',
        'together_male' => ' انتخاب اتاق برای آقایان ',
        'together_female' => ' انتخاب اتاق برای خانمها  ',
        'off_id' => 'تخفیف  ',
        'food' => 'سفارش غذا  ',
        'receipt' => ' فیش واریزی ',
        'commission_reason' => 'دلیل ارجاع به کمیسیون ',
        'old' => ' رمز عبور قدیمی',
