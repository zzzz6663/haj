...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <h5 class="card-header">تعریف نماینده  جدید
                <i class="ti ti-user-plus"></i>
            </h5>
            <div class="card-body">
                @include('master.error')
                <form action="{{ route("provincialAgent.store") }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="password" class="form-control" id="password"  type="text" value="{{ old("fathername") }}">
                            </div>
                            {{--  <div class="mb-3">
                                ...
                                <select class=" form-control select2" multiple name="provinces[]" multiple id="province_id" required>
                                    ...
                                    <option {{in_array($province->id,old('provinces',[]))?'selected':''}} value="{{ $province->id }}">{{ $province->name }}</option>
                                    @endforeach
                                </select>
                            </div>  --}}
                            <div class="mb-3">
            ...
            <div class="mb-3">
                <a href="{{ route("provincialAgent.index") }}" class="btn btn-warning">
                    برگشت
