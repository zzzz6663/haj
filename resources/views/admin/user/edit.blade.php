                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input name="title" class="form-control" id="title" placeholder="مثلا صنایع دستی" type="text" value="{{ old("title",$user->title) }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="admin_name" class="form-control" id="admin_name" placeholder="مثلا حمید رضایی" type="text" value="{{ old("admin_name",$user->admin_name) }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class=" form-control " name="province_id" id="province_id" required>
                                    ...
                                    @foreach (App\Models\Provincewe->get() as $province)
                            ...
                            <div class="mb-3">
                                ...
                                <select class=" form-control " name="city_id" id="city_id" required>
                                    ...
                                    @foreach (App\Models\City::where('province_id', old('province_id',$user->province_id))->whereActive(1)->get() as $city)
                                ...
                                <ul class="custom-control-group">
                                    <li>
                                        <div class="custom-control custom-checkbox custom-control-pro no-control checked">
                                            <input type="radio" class="custom-control-input" name="job" {{ old("job",$user->job)=="restaurant"?"checked":"" }} id="restaurant" value="restaurant">
                                    ...
                                    <li>
                                        <div class="custom-control custom-checkbox custom-control-pro no-control">
                                            <input type="radio" class="custom-control-input" name="job" {{ old("job",$user->job)=="museum"?"checked":"" }} id="museum_id" value="museum">
                                    ...
                                    <li>
                                        <div class="custom-control custom-checkbox custom-control-pro no-control">
                                            <input type="radio" class="custom-control-input" name="job" {{ old("job",$user->job)=="store"?"checked":"" }} id="store_id" value="store">
                                    ...
                                    <li>
                                        <div class="custom-control custom-checkbox custom-control-pro no-control">
                                            <input type="radio" class="custom-control-input" name="job" {{ old("job",$user->job)=="boom"?"checked":"" }} id="boom_id" value="boom">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="tell" class="form-control" id="tell" type="text" value="{{ old("tell",$user->tell) }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="price" class="form-control number_format" id="price" type="number" value="{{ old("price",$user->price) }}">
                                <span></span>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="visiting_hours">ساعت کاری</label>
                                <input name="visiting_hours" class="form-control" id="visiting_hours" type="text" value="{{ old("visiting_hours",$user->visiting_hours) }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="confirm">تایید حساب</label>
                                <select class="form-select" id="confirm" name="confirm">
                                    <option value="">انتخاب کنید </option>
                                    <option {{ old("confirm",$user->confirm)=="1" ?"selected":"" }} value="1">فعال</option>
                                    <option {{ old("confirm",$user->confirm)=="0" ?"selected":"" }} value="0">غیر فعال</option>
                                </select>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input name="latitude" class="form-control" id="latitude" hidden type="text" value="{{ old("latitude",$user->latitude) }}">
                                <input name="longitude" class="form-control" id="longitude" hidden type="text" value="{{ old("longitude",$user->longitude) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control no-resize" name="welfare" id="welfare">{{ old("welfare",$user->welfare) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="address"> آدرس</label>
                                <textarea class="form-control no-resize" name="address" id="address">{{ old("address",$user->address) }}</textarea>
                            </div>


                            <div class="mb-3">
                                <label class="form-label" for="history"> تاریخچه</label>
                                <textarea class="form-control no-resize" name="history" id="history">{{ old("history",$user->history) }}</textarea>
                            </div>
