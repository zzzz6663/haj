    ...
    <div class="col-md-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route("update.user.commission",$user->id) }}" method="post" enctype="multipart/form-data">
                    @csrf 
                    @method('post')
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="expert" class="form-control" id="expert" placeholder="مثلا قلب و عروق" type="text" value="{{ old("expert",$user->expert) }}">
                            </div>
