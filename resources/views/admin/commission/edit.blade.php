    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route("commission.update",$commission->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name" class="form-control" id="name" placeholder="" type="text" value="{{ old("name",$commission->name) }}">
                            </div>
                            <div class="mb-3">
