...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">لیست ناظراستانی</h3>
...
<div class="nk-block">
    <div class="card card-stretch">
        <div class="card-inner-group">
            <form action="{{ route('provincialSupervisor.index') }}" method="get" autocomplete="off">
                @csrf
                @method('get')
                    ...
                    <div class="">
                        <div class="card-tools align-items-center justify-content-between ">
                            <div class="form-inline  gx-3">
                                ...
                                <div class="form-wrap ">
                                    <span class="">
                                        <br>
                                        @if(request("_token"))
                                        <a href="{{ route("provincialSupervisor.index") }}" class="btn inline-block btn-danger"><i
                            ...
                            <div>
                                ...
                                <a href="{{route("provincialSupervisor.create")}}" class="btn btn-info">
                                    ناظر  جدید
                                </a>
                            </div>
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("provincialSupervisor.edit",$user->id)}}" class="btn btn-primary">
                                        ویرایش
                                    </a>
