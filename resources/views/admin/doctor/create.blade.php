                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="mobile" class="form-control" id="mobile"   type="text" value="{{ old("mobile") }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="expert" class="form-control" id="expert" placeholder=" " type="text" value="{{ old("expert") }}">
                                </div>
