...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">لیست مجموعه ها </h3>
            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        {{-- <li>
                            <a href="{{ route(" collection.create") }}" class="btn btn-white btn-outline-light"><span>کاربر
                                    جدید</span></a>
                        </li> --}}
...
<div class="nk-block">
    <div class="card card-stretch">
        <div class="card-inner-group">
            <form action="{{ route('collection.index') }}" method="get" autocomplete="off">
                @csrf
                @method('get')
                            ...
                            <div class="form-inline  gx-3">
                                ...
                                <div class="form-wrap ">
                                    <span class="">
                                        <br>
                                        @if(request("_token"))
                                        <a href="{{ route("collection.index") }}" class="btn inline-block btn-danger"><i
...
<div class="card-inner">
    {{ $collections->appends(Request::all())->links('admin.section.pagination') }}
</div>
