                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        ...
                        <div class="nk-block-des">
                            <p>با استفاده از نام
                                کاربری و رمز عبور خود به پنل سامانه پزشکی   دسترسی پیدا کنید.</p>
                        </div>
                    </div>
                </div>
                    <div class="form-group">
                        <div class="form-label-group">
                            <label class="form-label" for="username">نام
                                کاربری
                            </label>
                        </div>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" tabindex="1" id="username" name="username" placeholder=" username خود را وارد کنید">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap">
                            <a href="#" class="form-icon form-icon-right passcode-switch lg no_link "  tabindex="-2"  data-target="password">
                                <em class="passcode-icon icon-show icon ni ni-eye no_link"></em>
                                <em class="passcode-icon icon-hide icon ni ni-eye-off no_link"></em>
                            </a>
                            <input type="password" class="form-control form-control-lg"  tabindex="2" name="password" id="password" placeholder="رمز عبور خود را وارد کنید">
                        </div>
                    </div>
                    <div class="form-group">
                        <a class="link link-primary link-sm" tabindex="-1" href="{{ route("forget.password") }}">رمز عبور را فراموش کردید؟</a>
