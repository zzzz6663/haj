...
<div class="nk-block nk-block-middle nk-auth-body wide-xs">
    <div class="brand-logo pb-4 text-center">
        <a href="{{ route("login") }}" class="logo-link">
            <img class=" logo-img logo-img-lg" src="{{ asset(" /site/images/plogo.png") }}">
        </a>
    </div>
    <div class="card">
        <div class="card-inner card-inner-lg">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des">
                        <p>
                            برای ورود شماره همراه خود را وارد کنید و در انتها دکمه ارسال کد را بزنید
                        </p>
                    </div>
                </div>
            </div>
            <form action="html/pages/auths/auth-success-v2.html">
                <div id="first">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="number" class="form-control form-control-lg" id="mobile"
                ...
                <div id="second" style="display: none">
                    ...
                    <input type="number" name="" class="form-control form-control-lg" id="code"
