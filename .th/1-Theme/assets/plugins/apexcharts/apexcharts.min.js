...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).ApexCharts = e() }(this, (function() {
        ...
        b = function() {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || (C.showDelayedElements(), C.roundedCornerBars(M, a)) : C.animatePathsGradually(n(n({}, X), {}, { speed: g })), A.globals.dataChanged && P && T && C.animatePathsGradually(n(n({}, X), {}, { speed: u })), M
                }
            }, {
                key: "drawPattern",
                value: function(t, e, i) {
    ...
    var A = { name: "en", options: { months: ["فروردین", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["فروردین", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["شنبه", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "دانلود svg", exportToPNG: "دانلود png", exportToCSV: "دانلود CSV", menu: "منو", selection: "انتخاب", selectionZoom: "انتخاب زوم", zoomIn: "زوم داخل", zoomOut: "زوم بیرون", pan: "رنگ امیزی", reset: "بازگشت زوم" } } },
        S = function() {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    var c = i,
                        ...
                        g = h.move(c, a),
                        u = h.move(c, a);
                    return l.globals.previousPaths.length > 0 && (u = this.barCtx.getPreviousPath(n, o, !1)), { pathTo: g = g + h.line(c, s) + h.line(i + e - r, s) + h.line(d - r, s) + h.line(d - r, a) + h.line(i + e - r, a) + "z", pathFrom: u = u + h.line(c, a) + h.line(d - r, a) + h.line(d - r, a) + h.line(d - r, a) + h.line(c, a) }
                }
            }, {
                key: "getBarpaths",
                value: function(t) {
                    ...
                    var g = e,
                        u = e + i;
                    return { pathTo: c = c + h.line(s, g) + h.line(s, e + i - r) + h.line(s, u - r) + h.line(a, u - r) + h.line(a, e + i - r) + "z", pathFrom: d = d + h.line(a, g) + h.line(a, u - r) + h.line(a, u - r) + h.line(a, u - r) + h.line(a, g) }
                }
            }]), t
        }(),
        X = function() {
        ...
        N = function() {
            function t(i) { e(this, t), this.opts = i }
            return a(t, [{ key: "init", value: function() { var t = new R(this.opts).init({ responsiveOverride: !1 }); return { config: t, globals: (new H).init(t) } } }]), t
        }(),
        O = function() {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    var e = t.t,
                        ...
                        o = this.w,
                        l = this.ttCtx;
                    Object.keys(a).forEach((function(t) { "string" == typeof a[t] && (a[t] = f.sanitizeDom(a[t])) }));
                    var h = a.val,
                        c = a.xVal,
                        d = a.xAxisTTVal,
                        g = a.zVal,
