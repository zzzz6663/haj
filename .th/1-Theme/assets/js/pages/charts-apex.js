$(document).ready(function() {
    ...
    var options3 = {
        ...
        xaxis: {
            categories: ['اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'Oct'],
            labels: {
                style: {
                    colors: 'rgba(94, 96, 110, .5)'
                }
    ...
    var options5 = {
        series: [{
                name: 'حباب 1',
                data: generateDataBubble(new Date('11 اردیبهشت 2017 GMT').getTime(), 20, {
                    min: 10,
                    max: 60
                })
            },
    ...
    var options6 = {
        ...
        xaxis: {
            type: 'category',
            categories: ['کد 1', 'کد 2', 'کد 3', 'کد 4', 'کد 5', 'کد 6', 'کد 7', 'کد 8', 'کد 9', 'کد 10', 'کد 11', 'کد 12', 'کد 13', 'کد 14', 'کد 15']
        },
        title: {
